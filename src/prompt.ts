 ...
 *
 * When `options.supportPhase` is set, drops sales-specific blocks (framework /
 * hooks / skills / funnel stage / few-shot) and replaces them with a calm
 * FAQ-support block. Persona, voice, guardrails, KB grounding + context
 * stay intact.
 */
