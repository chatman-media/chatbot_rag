...
```bash
bun add @chatman-media/chatbot_rag     # Bun
npm install @chatman-media/chatbot_rag # npm / pnpm / yarn
```
...
```ts
import type { IKbStore, KbSearchHit } from "@chatman-media/chatbot_rag";
...
```ts
import { ingestFile, ingestDirectory, ingestText } from "@chatman-media/chatbot_rag";
...
```ts
import { answerWithRag } from "@chatman-media/chatbot_rag";
...
### Зачем @chatman-media/chatbot_rag?
...
### 为什么选择 @chatman-media/chatbot_rag？
